...
public struct OnboardingView: View {
    ...
    private var accessibilityScreen: some View {
        VStack(spacing: 16) {
            ...
            Text("Required to type dictated text directly into Safari, Slack, Notes, VS Code, and other apps.")
                .font(.body)
                .multilineTextAlignment(.center)
                .foregroundColor(.secondary)
                .padding(.horizontal, 32)
    ...
    private var shortcutScreen: some View {
        VStack(spacing: 16) {
            ...
            Text("Default recommendation: Hold Fn / Globe to dictate, release to insert.")
                .font(.caption)
                .foregroundColor(.secondary)
        }
    }
    ...
    private var modelScreen: some View {
        VStack(spacing: 16) {
            ...
            Text("Recommended: Whisper Base Multilingual\nBest balance of speed and high accuracy for German and English.")
                .font(.body)
                .multilineTextAlignment(.center)
                .foregroundColor(.secondary)
            
            VStack(spacing: 8) {
                Text("Pre-configured and ready to run on Neural Engine.")
                    .font(.caption)
                    .foregroundColor(.green)
            }
        }
    ...
    private var testScreen: some View {
        VStack(spacing: 16) {
            ...
            Text("Place the cursor below, hold Fn and say:\n\"LocalFlow is running entirely on my Mac.\"")
                .font(.body)
                .multilineTextAlignment(.center)
                .foregroundColor(.secondary)
